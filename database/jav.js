...
for (var i = 0; i < jav.length; i++) {
	...
	jepang += "<div class='jepang-card mb-3' data-nama='" + title + "'><a href='https://dood.la/e/"+ link +"' target='_blank' style='color:black' onclick='ads()'><div class='row sort-item'><img src='" + poster + "' alt='" + title + "' style='max-inline-size:100%;aspect-ratio: 16/9;object-fit: cover;border-radius:2px'><p id='judul-komik' align='center' style='margin-top:7px'><b>" + title + "</b></p></div></a></div>";
}
